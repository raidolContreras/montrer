        ...
        <div class="card-box-style">
            ...
            <form class="account-wrap" id="companyForm">
                <div class="row">
                    ...
                    <!-- seleccionar partida -->
                    <div class="col-md-3">
                        <label for="partida" class="form-label">Partidas<span class="required"></span></label>
                        <select name="partida" id="partida" class="form-select form-control" disabled>
                            <option value="">Selecciona un area primero</option>
                        </select>
                    </div>
