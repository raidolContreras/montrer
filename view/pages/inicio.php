										...
										<div class="row justify-content-center">
											...
											<div class="col-lg-3 col-sm-6">
												<div class="single-audience d-flex justify-content-between align-items-center">
													...
													<div class="icon">
														<img src="assets/img/svg/eye.svg" alt="eye">
													</div>
												</div>
											</div>
											...
											<div class="col-lg-3 col-sm-6">
												<div class="single-audience d-flex justify-content-between align-items-center">
													...
													<div class="icon">
														<img src="assets/img/svg/timer.svg" alt="timer">
													</div>
												</div>
											</div>
									...
									<table class="table align-middle">
										...
										<tbody>
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/link.svg" alt="link">
													</a>
												</th>
												<td>
													<span>Homepage</span>
									...
									<table class="table align-middle">
										...
										<tbody>
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/apps/chrome.svg" alt="chrome">
											...
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/apps/mozilla.svg" alt="mozilla">
											...
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/apps/safari.svg" alt="safari">
											...
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/apps/edge.svg" alt="edge">
											...
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/apps/opera.svg" alt="opera">
											...
											<tr>
												<th scope="row">
													<a href="index.html">
														<img src="assets/img/svg/apps/uc-browser.svg" alt="uc-browser">
		...
		<div class="template-sidebar-option">
			<div class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasRight">
				<div class="offcanvas-header">
					<a href="index.html">
						<img src="assets/img/svg/main-logo.svg" alt="main-logo">
					</a>
