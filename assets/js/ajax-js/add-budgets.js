            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response === 'ok') {
                        ...
                        showAlertBootstrap('!Atención¡', 'Presupuesto ya asignado a esta área.');
...
$("#area").change(function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function (response) {
            // si esta vacio que mande mensaje de error
            if (response.length == 0) {
                showAlertBootstrap2('¡Atención!', 'El departamento seleccionado no dispone de partidas asignadas.<br>¿Desea usted proceder a asignar partidas a este departamento?', 'registerPartida');
                $("#partidas").html('<option value="">No hay partidas disponibles</option>');
            } else {
